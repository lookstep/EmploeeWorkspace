    ...
    public class LaborCostRepositoryTest
    {
        ...
        public void GetLaborCost()
        {
            ...
            _context.LaborCosts.AddRange(
                new LaborCost() { Id = 1, Date = System.DateTime.Now, AssignmentId = 1, EmployeeId = 1},
                new LaborCost() { Id = 2, Date = System.DateTime.Today, AssignmentId = 2, EmployeeId = 2 }
                );
        ...
        public void UpdateLaborCost()
        {
            ...
            var addedLaborCost = new LaborCost() { Id = 1, Date = System.DateTime.Now, AssignmentId = 1, EmployeeId = 1 };
            ...
            var changedLaborCost = new LaborCost() { Id = 1, Date = System.DateTime.Today, AssignmentId = 2, EmployeeId = 2 };
        ...
        public void DeleteLaborCost()
        {
            ...
            _context.LaborCosts.AddRange(
                new LaborCost() { Id = 1, Date = System.DateTime.Now, AssignmentId = 1, EmployeeId = 1 },
                new LaborCost() { Id = 2, Date = System.DateTime.Today, AssignmentId = 2, EmployeeId = 2 },
                new LaborCost() { Id = 3, Date = System.DateTime.UtcNow, AssignmentId = 1, EmployeeId = 2 }
                );

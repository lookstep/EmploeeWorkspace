...
namespace EmployeeTask.API.Controllers
{
    ...
    {
        private readonly IDbRepository<Assignment> _taskForEmployeeRepository;
        /// <summary>
        /// Внедрение зависимости интерфейса репазитория
        /// </summary>
        /// <param name="taskForEmployeeRepository">интерфейс репазитория</param>
        public AssignmentController(IDbRepository<Assignment> taskForEmployeeRepository)
        {
        ...
        public async Task<ActionResult<IEnumerable<Assignment>>> GetTasksForEmployees()
        {
            try
            {
        ...
        [ProducesResponseType(typeof(string), StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<Assignment>> GetTaskForEmployeeById(int id)
        {
            try
            {
        ...
        [ProducesResponseType(typeof(string), StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<Assignment>> CreateTasksForEmployees(Assignment taskForEmployee)
        {
            try
            {
        ...
        [ProducesResponseType(typeof(string), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(string), StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<Assignment>> UpdateTasksForEmployee(int id, Assignment taskForEmployee)
        {
            try
            {
